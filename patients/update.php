...
include_once 'config.php';
 ...
 print_r($_POST);
  ...
  $query = mysqli_query($conn, "UPDATE doctor SET name='$name',number='$number',address='$address',department='$department',email='$email',password='$password' WHERE id= $id");
  ...
  echo "Error updating record: ";
			...
			$results = mysqli_query($conn,"SELECT * FROM doctor WHERE id= $id " );
...
<input type="text" name="address" value="<?php echo $row1["address"]; ?>" id="address" class="form-control">
</div>
<div class="form-group">

<input type="text" name="department" value="<?php echo $row1["department"]; ?>" id="department" class="form-control">
</div>
 <div class="form-group">
...
<button class="btn btn-success" type="submit" name="update">View Data</button>
