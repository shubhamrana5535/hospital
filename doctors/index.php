...
<input type="text" value="" name="name" class="form-control" placeholder = "Doctor's name" require="required">
</div>
<div class="form-group">

<input type="text" value="" name="number" class="form-control" placeholder = "Doctor's number" require="required">
</div>
<div class="form-group">

<input type="text" value="" name="address" class="form-control" placeholder = "Doctor's address" require="required">
</div>
<div class="form-group">

<input type="text" value="" name="department" class="form-control" placeholder = "Doctor's deparment" require="required">
</div>
<div class="form-group">

<input type="text" value="" name="email" class="form-control" placeholder = "Doctor's email" require="required">
</div>
<div class="form-group">

<input type="text" value="" name="password" class="form-control" placeholder = "Doctor's password" require="required">
</div>
...
<footer class=" p-5 text-center text-light p-3 m-3" style="background:#40E0D0">
    <h2>
      Thanks to you
    </h2>
  </footer>
